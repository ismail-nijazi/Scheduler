      ...
      <div className="newProject">
        ...
        <div className="content">
          ...
          <div className="row">
            <div className="col">
              ...
              <input
                ...
                placeholder="Title"
                onChange={(event) =>
                  setProject({ ...newProject, name: event.target.value })
                }
              />
            </div>
          </div>
          <div className="row">
            <div className="col">
              ...
              <Select
                ...
                className="select"
              >
                <MenuItem sx={styles.menuItem} value={colors.defaultProject}>
                  <div
                ...
                {projectColors.map((color) => (
                  <MenuItem sx={styles.menuItem} value={color} key={color}>
                    <div
                      className="color-option"
                      style={{
          ...
          <div className="row footer">
            <div className="col">
              <button type="button" className="btn primary-btn" onClick={createProject}>
