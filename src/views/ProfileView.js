  ...
  return (
    <div className="modal">
      <div className="profile">
        ...
        <div className="head">
          <span className="title">Pofile</span>
          <div>
            <button
              type="button"
        ...
        <div className="content">
          ...
          <div className="row">
            ...
            <div className="col">
              ...
              <input
                ...
                id="capacity"
                onChange={(event) =>
                  setAccountInfo({ ...accountInfo, capacity: event.target.value })
                }
          ...
          <div className="footer">
            <button type="button" className="btn primary-btn" onClick={updateProfile}>
              Update profile
