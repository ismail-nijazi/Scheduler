      ...
      <div className="edit-task">
        <div className="head">
					<span className="title">{
						isNewTask ? "Add a new" : "Update the"} task
					</span>
					<button
            type="button"
        ...
        <div className="content">
            ...
            <div className="col">
              <label id="task-category">Project</label>
							<Select
								...
								label="Project"
								onChange={(event) => setTask({
									...newTask, category_id: event.target.value
								})}
								className="select"
							>
								<MenuItem 
          ...
          <div className="row footer">
            <div className="col">
              <button type="button" className="btn primary-btn">Add</button>
            </div>
          </div>
        </div>
      </div>
