...
import { FaAngleDown, FaAngleUp, FaPlus, FaEllipsisV } from 'react-icons/fa';
  ...
  return (
    <header className="search-header">
      <div className="row">
        ...
        <div className="search-bar">
          <input
            ...
            placeholder="search"
          />
          <Link to={newTaskRoute} className="add-btn">
            <FaPlus size={20} />
          </Link>
        </div>
      </div>
      <div className="row filter">
        ...
        >
          <span>Sort by</span>
          {!sortOptions ? <FaAngleDown size={24} /> : <FaAngleUp size={24} />}
        </button>
